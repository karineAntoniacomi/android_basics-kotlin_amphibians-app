...
/** This binding adapter displays the [AmphibianApiStatus] of the network request in an
 * image view. When the request is loading, it displays a loading_animation.  If the
